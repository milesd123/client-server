...
int main(int argc, char* argv[])
{
    ...
    stream_encrypt((unsigned char*)message, (int) strlen(message), key, iv, message_encrypted);
    ...
    stream_decrypt((unsigned char*)incoming_buffer, (int) recvd, key, iv, (unsigned char*)decrypted_message);
